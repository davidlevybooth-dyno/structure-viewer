...
// import ThemeToggle from "./ThemeToggle"; // TODO: Create ThemeToggle component
      ...
      <AnimatePresence>
        {(open || typeof window !== "undefined") && (
          <motion.aside
            ...
            transition={{ type: "spring", stiffness: 260, damping: 28 }}
            className={cls(
              "z-50 flex h-full w-64 shrink-0 flex-col border-r border-zinc-200/60 bg-white dark:border-zinc-800 dark:bg-zinc-900",
          ...
          >
            <div className="flex items-center gap-2 border-b border-zinc-200/60 px-3 py-3 dark:border-zinc-800">
              <div className="flex items-center gap-2">
                ...
                <div className="text-sm font-semibold tracking-tight">p0</div>
              </div>
